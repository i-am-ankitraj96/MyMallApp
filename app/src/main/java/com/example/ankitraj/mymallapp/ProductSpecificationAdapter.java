...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    @Override
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case ProductSpecificationModel.SPECIFICATION_BODY:
                View viewBody = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_specification_item_layout, parent, false);
                return new ViewHolder(viewBody);
    ...
    @Override
    public void onBindViewHolder(ProductSpecificationAdapter.ViewHolder holder, int position) {
        ...
        switch (productSpecificationModelList.get(position).getType()) {
            ...
            case ProductSpecificationModel.SPECIFICATION_BODY:
                ...
                String featureDetail = productSpecificationModelList.get(position).getFeatureName();
